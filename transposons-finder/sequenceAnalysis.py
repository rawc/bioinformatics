    ...
    def readFastqStdIn (self,inp):
        ...
        with inp as fileH:
            ...
            for line in fileH:
                line = line.upper()
                print(line)
                if line.startswith ('A') or line.startswith ('N') or line.startswith ('C') or line.startswith('G') or line.startswith('T'):
                    print('starts with seq')
                    yield header,line[1:].rstrip()
                    header = line[1:].rstrip()
                    sequence = ''
                else :
                    print('no it doesnt')
